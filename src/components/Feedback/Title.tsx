...
export default function Title() {
    ...
    return (
        <div className="flex flex-col gap-[16px]">
            ...
            <input defaultValue={productRequest.title} type="text" onChange={(e) => setProductRequest({ ...productRequest, title: e.target.value })} id="title" className={`w-[100%] bg-[#F7F8FD] outline-none border-solid border-[#4661E6] focus:border-[1px] ${errors && !productRequest.title ? "border-[#D73737]! border-[1px]" : undefined} rounded-[5px] p-[12px_24px_12px_24px] ${P2} `} />
